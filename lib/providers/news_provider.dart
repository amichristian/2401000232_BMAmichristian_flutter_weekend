  ...
  List<NewsArticle> build() {
    return [
      NewsArticle(
        ...
        description:
            'New technologies are helping people communicate, learn, and work more efficiently.',
      ...
      NewsArticle(
        ...
        description:
            'Technology continues to create new opportunities for businesses and communities across Africa.',
      ...
      NewsArticle(
        ...
        description:
            'Students are increasingly using digital tools to access educational resources.',
...
final newsProvider =
    NotifierProvider<NewsNotifier, List<NewsArticle>>(
  NewsNotifier.new,
);